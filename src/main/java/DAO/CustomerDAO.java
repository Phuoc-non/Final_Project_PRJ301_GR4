    ...
    public List<Order> getAllCustomer() {
        ...
        try {
            String query = "SELECT\n"
                    ...
                    + "FROM Orders O\n"
                    + "LEFT JOIN Registration R ON R.username = O.username\n"
                    + "WHERE R.isAdmin = 0\n"
            ...
            while (rs.next()) {
                ...
                order.setTotalQuantity(rs.getInt("totalOrders"));
                order.setDatebuy(rs.getDate("CreateOrder"));/// kiểu date
    ...
    public Order getLastOrderByRegistrationId(int registrationId) {
        ...
        try (PreparedStatement ps = this.getConnection().prepareStatement(sql)) {
            ...
            if (rs.next()) {
                ...
                o.setDatebuy(rs.getDate("dateBuy"));
