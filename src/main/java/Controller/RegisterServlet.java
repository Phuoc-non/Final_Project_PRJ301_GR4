...
public class RegisterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userDAO.checkDuplicateUsername(username)) {
            request.setAttribute("errorRegister", "Username existed!");
        ...
        if (success) {
            request.setAttribute("messageRegister", "Successful registration! You can log in.");
            request.setAttribute("activeTab", "login");
        } else {
            request.setAttribute("errorRegister", "Register for failure! Please try again.");
            request.setAttribute("activeTab", "register");
        }
        request.getRequestDispatcher("/WEB-INF/logins/login.jsp").forward(request, response);
    }
