...
//    }
//
//    public Orders getLastOrderByRegistrationId(int registrationId) {
...
//    }
//
//    public List<Orders> getCustomerList(int page) {
//        List<Orders> list = new ArrayList<>();
//        try {
//            String sql = """
...
//                reg.setAddress(rs.getString("reg_address"));
//
//                // ✅ Tạo đối tượng Orders chứa cả Registration
//                Orders order = new Orders(orderId, dateBuy, total, name, phone, address, reg);
//                list.add(order);
//            }
//
//        } catch (SQLException e) {
