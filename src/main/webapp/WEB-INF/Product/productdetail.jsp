                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                                    <div class="tg-postbook">
                                                        ...
                                                        <figure class="tg-featureimg"><img src="${product.img}" alt="image description"></figure>
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                                    <div class="tg-productcontent">
                                                        ...
                                                        <span class="tg-bookwriter">By: <a href="javascript:void(0);">${product.author}</a></span>
                                                        ...
                                                        <ul class="tg-productinfo">
                                                            <li><span>Format:</span><span>${product.format}</span></li>
                                                            <li><span>Pages:</span><span>${product.pages}</span></li>
                                                            <li><span>Dimensions:</span><span>${product.dimension}</span></li>
